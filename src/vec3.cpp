...
inline vec3 operator*(fpoint t, const vec3 &v) {
    return vec3(v.x() * t, v.y() * t, v.z() * t);
}

inline vec3 operator*(const vec3 &v, fpoint t) { return t * v; }

inline vec3 operator/(const vec3 &v, fpoint t) { return v * (1 / t); }

inline fpoint dot(const vec3 &u, const vec3 &v) {
